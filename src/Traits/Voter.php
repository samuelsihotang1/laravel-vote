...
trait Voter
{
   ...
   * @param Model  $object
   * @param string $type
   * @return \samuelsihotang1\LaravelVote\Vote
   * @throws \samuelsihotang1\LaravelVote\Exceptions\UnexpectValueException
   */
  ...
  {
    /* @var \samuelsihotang1\LaravelVote\Vote $relation */
